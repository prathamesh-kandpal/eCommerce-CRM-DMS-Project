"""
Django settings for ecommerce_crm project.
...
SECRET_KEY = 'django-insecure-x5q-&x#2tn5ru6an7!*)p107#qo6xz6utx@ugsa+#%ot0jl-r-'
...
ROOT_URLCONF = 'ecommerce_crm.urls'
...
WSGI_APPLICATION = 'ecommerce_crm.wsgi.application'
